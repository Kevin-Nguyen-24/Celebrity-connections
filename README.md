...
- Try different celebrities
- Some celebrities may not have direct Wikipedia connections within 4 steps
- Ensure celebrity names are spelled correctly

**Issue**: Slow search times
- Wikipedia API can be slow during peak hours
- The search depth is limited to 4 to balance speed and results
